      ...
      <Header title={Translations.visitCreation.pagetitle} subtitle={Translations.visitCreation.pagesubtitle} />
          ...
          <form onSubmit={handleSubmit}>
            <Box display="grid"
              ...
              <Grid  xs={12} sm={12} md={12} lg={12} container  rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                
                <Grid item xs={3} >
                <FormControl  variant="outlined" fullWidth>
                    <InputLabel shrink>{Translations.visitCreation.speciality}</InputLabel>
                      <Select
                        labelId="demo-simple-select-filled-label"
                        id="demo-simple-select-filled"
                ...
                <Grid item xs={3}   >
                <FormControl  variant="outlined" fullWidth>
                    <InputLabel shrink>{Translations.visitCreation.DocName}</InputLabel>
                      <Select
                        labelId="demo-simple-select-filled-label"
                        id="demo-simple-select-filled"
                ...
                <Grid item xs={3}  >
                <FormControl  variant="outlined" fullWidth>
                    <InputLabel shrink>{Translations.visitCreation.visitType}</InputLabel>
                      <Select
                        labelId="demo-simple-select-filled-label"
                        id="demo-simple-select-filled"
            ...
            <Grid  xs={12} sm={12} md={12} lg={12} container  rowSpacing={4} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
