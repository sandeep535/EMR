...
export const AddPaymentSchema = Yup.object().shape({
  ...
  paymentAmount: Yup.number().typeError('Enter a valid amount').required('Payment Amount is required'),
  paymentMethod: Yup.object().nullable().required('Payment Mode is required'),
  transactionNumber: Yup.string().nullable(),
